...
test_batch_text = open('/Users/xiangcheng/Documents/data insight/digital-wallet/paymo_input/batch_payment.txt', 'r')
...
for i in range(len(test_batch_data))[1:]:
    if str(test_batch_data[i])[0:].startswith('2016'):
...
test_stream_text = open('/Users/xiangcheng/Documents/data insight/digital-wallet/paymo_input/stream_payment.txt', 'r')
...
f1 = open('/Users/xiangcheng/Documents/data insight/digital-wallet/paymo_output/output1.txt','a')

f2 = open('/Users/xiangcheng/Documents/data insight/digital-wallet/paymo_output/output2.txt','a')


f3 = open('/Users/xiangcheng/Documents/data insight/digital-wallet/paymo_output/output3.txt','a')
...
for i in np.arange(n):
    ...
    if str(test_stream_data[i]).startswith('2016'):
        ...
        if g.f_of_f(test_stream_id1, test_stream_id2) or (g.had_transaction_before(test_stream_id1, test_stream_id2)):
        	...
        	f2.write('unverified')
        #lst05.append(g.find_path(test_stream_id1, test_stream_id2))
        #lst06.append((test_stream_id1, test_stream_id2))
        f3.write(g.fourth_connections(test_stream_id1, test_stream_id2))
